/********Tong hop cac chuong trinh con cua Slowlove trong khi lap trinh C cho VDK*********/
 /* chu y:
 ...
 */
 ...
 {
 unsigned char ma_so[10]={0xc0,0xf9,0xa4,0xb0,0x99,0x92,0x82,0xf8,0x80,0x90};   // ma cua so 0-->9 duoi dang hex de hien thi tra led 7 doan
 return ma_so[n];
 }
