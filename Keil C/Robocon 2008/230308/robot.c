...
dctrai=dcphai=1;delay(20000);		  //thiet lap chieu cua 2 dong co
...
void retrai(void){
dctrai=0;dcphai=1;delay(20000);
while(P0!=lechphai3)v_trai1();
}
/*******chuong trinh re phai********/
void rephai(void){
dctrai=1;dcphai=0;delay(20000);
while(P0!=lechtrai3)v_thang();
}
/********chuong trinh chinh*********/
void main(void){
unsigned char x;
