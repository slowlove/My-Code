...
dctrai=dcphai=1;delay(250);		  //thiet lap chieu cua 2 dong co
...
void retrai(void){
dctrai=0;dcphai=1;delay(250);
while(P0!=lechphai7)v_thang();
dctrai=1;dcphai=0;delay(250);
v_thang();delay(10900);
}
/*******chuong trinh re phai********/
void rephai(void){
dctrai=1;dcphai=0;delay(250);
while(P0!=lechtrai7)v_thang();
dctrai=0;dcphai=1;delay(250);
v_thang();delay(10900);
}
/********chuong trinh chinh*********/
