...
unsigned char total;
total=((led1==1)+(led2==1)+(led3==1)+(led4==1)+(led5==1)+(led6==1)+(led7==1)+(led8==1));
return(total);}
/********chuong trinh con chay thang*******/
void chaythang(unsigned char vach){
dctrai=dcphai=1;
delay(1000);	//tao tre cho role du thoi gian de chuyen doi giua 2 che do dong va ngat
...
chaythang(5);
while(1){stop();delay(100);}	//dung robot
}					   