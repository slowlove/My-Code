...
banhtrai(140);
banhphai(255);}
/*********van toc goc cua trai hoac phai************/
void v_re(void){
banhtrai(190);
banhphai(200);}
/*********chuong trinh stop************/
...
dctrai=dcphai=1;delay(800);		  //thiet lap chieu cua 2 dong co
...
void retrai(void){
dctrai=0;dcphai=1;delay(800);
while(P0!=lechphai7)v_re();
dctrai=1;dcphai=0;delay(800);
v_re();delay(8000);	//phanh dao chieu dong co	
}
/*******chuong trinh re phai********/
void rephai(void){
dctrai=1;dcphai=0;delay(800);
while(P0!=lechtrai7)v_re();
dctrai=0;dcphai=1;delay(800);
v_re();delay(8000);	 //phanh dao chieu dong co
}
/********chuong trinh chinh*********/
